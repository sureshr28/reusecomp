		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reuse UI Component",
									"targetURL": "#demosureshreusecomp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demosureshreusecomp-display": {
								"semanticObject": "demosureshreusecomp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.suresh.reusecomp",
									"url": sap.ui.require.toUrl("demo/suresh/reusecomp")
								}
							}
						}
					}
